        ...
        <div className="mx-auto grid max-w-6xl gap-12 px-6 py-20 md:grid-cols-[1.3fr_1fr] md:py-28">
          <div className="animate-rise">
            ...
            <div className="mt-8 max-w-lg">
              ...
              <div className="mt-8 rounded-3xl p-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4 border"
                style={{ background: "var(--surface-container-low)", borderColor: "var(--glass-border)" }}>
                <div className="flex items-center gap-3">
                  <span className="text-2xl">📞</span>
                  <div>
                    <h4 className="text-xs font-black uppercase tracking-wider" style={{ color: "var(--on-surface)" }}>Support Helpline</h4>
                    <p className="text-[11px] mt-0.5" style={{ color: "var(--outline)" }}>Call/WhatsApp anyone below for instant help</p>
                  </div>
                </div>
